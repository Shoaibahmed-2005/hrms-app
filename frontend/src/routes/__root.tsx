...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Enterprise HRMS with attendance, leave, payroll, and workforce analytics." },
      { property: "og:title", content: "HRMS — Human Resource Management" },
      { property: "og:description", content: "Enterprise HRMS with attendance, leave, payroll, and workforce analytics." },
...
function RootComponent() {
  ...
  const router = useRouter();
  useEffect(() => {
    // Listen for token changes (login/logout) and refresh the router
